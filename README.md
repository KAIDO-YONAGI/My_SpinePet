...
| Document | 中文 | English |
| --- | --- | --- |
| Usage (this file) | [README.zh-CN.md](README.zh-CN.md) | **README.md** |
| Asset policy | [ASSETS.zh-CN.md](ASSETS.zh-CN.md) | [ASSETS.md](ASSETS.md) |
| **Asset import guide** (four resource kinds, format rework, tooling, AI assistance, troubleshooting) | [IMPORT.zh-CN.md](IMPORT.zh-CN.md) | [IMPORT.md](IMPORT.md) |
| Third-party components and licenses | [THIRD_PARTY_NOTICES.zh-CN.md](THIRD_PARTY_NOTICES.zh-CN.md) | [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md) |
...
- A bare Windows machine needs no VC++ redistributable; run `Check-Environment.ps1`
  ...
  Python) is in [section 8 of IMPORT.md](IMPORT.md).
...
**The full specification is in [`IMPORT.md`](IMPORT.md)** (how each of the four
...
- One layout only: `res\<full resource name>\<skin code>\<state>\`, with skeleton
  ...
  character ID (see section 2 of IMPORT.md).
...
<release package>\
  ...
  IMPORT.md / IMPORT.zh-CN.md   asset import guide (four kinds, format rework, tooling, AI assistance, troubleshooting)
  ...
  THIRD_PARTY_NOTICES.md / .zh-CN.md   third-party components and licenses
  ASSETS.md / ASSETS.zh-CN.md   asset sourcing and licensing boundaries
...
- The project **contains no game assets**. Character assets remain the property of
  ...
  them to you. See [ASSETS.md](ASSETS.md).
